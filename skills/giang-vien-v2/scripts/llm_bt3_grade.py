...
from schema import GraderResult, RubricBT3, RateLimitError, clamp
...
def llm_grade_bt3(
    *,
    ...
    system = (
        "Bạn là giảng viên chấm BT3 (2 CV cho 2 vị trí). Chấm theo rubric 5 tiêu chí (TC1..TC5). "
